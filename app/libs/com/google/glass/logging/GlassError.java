...
public enum GlassError
{
  ...
  static
  {
    COMPASS_SETUP_FAILS = new GlassError("COMPASS_SETUP_FAILS", 2, "inv_mpu_iio: compass setup failed", "Compass setup fails", Feedback.RecoveryAction.SHOULD_REBOOT, ReportAction.EVENT_ONLY, "18", new ErrorAttachment[0]);
    ...
    TOUCHPAD_ERROR = new GlassError("TOUCHPAD_ERROR", 3, "Unable to find or reset touchpad device", "Touchpad error", localRecoveryAction1, localReportAction1, "10", arrayOfErrorAttachment1);
    ...
    MEM_HEAP_ERROR = new GlassError("MEM_HEAP_ERROR", 4, "@@@ ABORTING: HEAP MEMORY CORRUPTION", "Memory heap error", localRecoveryAction2, localReportAction2, "12", arrayOfErrorAttachment2);
    ...
    HEAP_ADDR_ERROR = new GlassError("HEAP_ADDR_ERROR", 5, "@@@ ABORTING: INVALID HEAP ADDRESS", "Heap address error", localRecoveryAction3, localReportAction3, "13", arrayOfErrorAttachment3);
    ...
    SYSPROXY_TEARDOWN_ERROR = new GlassError("SYSPROXY_TEARDOWN_ERROR", 6, "@@@ SYSPROXY TEARDOWN FAILED", "sysproxy teardown error", localRecoveryAction4, localReportAction4, "15", arrayOfErrorAttachment4);
    BLUETOOTH_MEM_HEAP_ERROR = new GlassError("BLUETOOTH_MEM_HEAP_ERROR", 7, ">>> com.google.glass.bluetooth <<<", "Bluetooth memory heap error", Feedback.RecoveryAction.SHOULD_REBOOT, ReportAction.NONE, null, new ErrorAttachment[0]);
    GlassError[] arrayOfGlassError = new GlassError[8];
    arrayOfGlassError[0] = FPGA_RESET;
    arrayOfGlassError[1] = TWL_RESET;
    arrayOfGlassError[2] = COMPASS_SETUP_FAILS;
    arrayOfGlassError[3] = TOUCHPAD_ERROR;
    arrayOfGlassError[4] = MEM_HEAP_ERROR;
    arrayOfGlassError[5] = HEAP_ADDR_ERROR;
    arrayOfGlassError[6] = SYSPROXY_TEARDOWN_ERROR;
    arrayOfGlassError[7] = BLUETOOTH_MEM_HEAP_ERROR;
  }
