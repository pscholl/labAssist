...
public abstract class RemoteCallbackBroadcaster<Callback extends IInterface>
{
  ...
  public final void clear()
  {
    ...
    for (int j = 0; j < i; j++)
    {
      IInterface localIInterface = this.callbacks.getBroadcastItem(j);
      this.callbacks.unregister(localIInterface);
    }
    finishBroadcast();
  }
  ...
  public final void doOperation(BroadcastTo paramBroadcastTo, RemoteCallbackOperation<Callback> paramRemoteCallbackOperation)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 96	com/google/glass/util/remote/RemoteCallbackBroadcaster$1:$SwitchMap$com$google$glass$util$remote$RemoteCallbackBroadcaster$BroadcastTo	[I
    //   5: aload_1
    //   6: invokevirtual 101	com/google/glass/util/remote/RemoteCallbackBroadcaster$BroadcastTo:ordinal	()I
    //   9: iaload
    ...
    //   48: aload_1
    //   49: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   52: invokevirtual 119	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   55: invokespecial 122	java/lang/AssertionError:<init>	(Ljava/lang/Object;)V
    //   58: athrow
    //   59: astore_3
    //   60: aload_0
    //   61: monitorexit
    ...
    //   64: aload_0
    //   65: aload_2
    //   66: invokespecial 124	com/google/glass/util/remote/RemoteCallbackBroadcaster:broadcastToAll	(Lcom/google/glass/util/remote/RemoteCallbackOperation;)V
    //   69: aload_0
    //   70: monitorexit
    //   71: return
    //   72: aload_0
    //   73: aload_2
    //   74: invokespecial 126	com/google/glass/util/remote/RemoteCallbackBroadcaster:broadcastToTopOfStack	(Lcom/google/glass/util/remote/RemoteCallbackOperation;)V
    //   77: goto -8 -> 69
    //
    // Exception table:
    //   from	to	target	type
