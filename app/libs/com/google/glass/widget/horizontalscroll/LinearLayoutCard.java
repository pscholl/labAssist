...
public class LinearLayoutCard extends LinearLayout
  implements Card
{
  public LinearLayoutCard(Context paramContext)
  {
    super(paramContext);
  }

  public LinearLayoutCard(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  public LinearLayoutCard(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.google.glass.widget.horizontalscroll.LinearLayoutCard
