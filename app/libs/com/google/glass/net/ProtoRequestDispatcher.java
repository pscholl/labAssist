    ...
    if (i < paramBatchResponse.response.length)
    {
      ...
      while (true)
      {
        ...
        if (localRequest.logMetrics)
          logRequestMetrics(localRequest.path, localRequest.requestProto.getCachedSize(), localResponseWrapper.getData().length);
      }
    }
    return bool;
  }
    ...
    while (true)
    {
      ...
      try
      {
        ...
        do
        {
          ...
          localRequestWrapper.setPath(localRequest1.path);
          localRequestWrapper.setData(MessageNano.toByteArray(localRequest1.requestProto));
        ...
        localBatchHeader.setDispatcherId(this.dispatcherId);
        ...
        localBatchRequest.setHeader(localBatchHeader);
