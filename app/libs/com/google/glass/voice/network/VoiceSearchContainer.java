...
public class VoiceSearchContainer
{
  ...
  private VoiceSearchContainer(Context paramContext)
  {
    ...
    this.locationManagerHelper = new LocationManagerHelper((LocationManager)paramContext.getSystemService("location"), new UserEventHelper(paramContext), ClockProvider.get());
