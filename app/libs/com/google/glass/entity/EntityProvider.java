...
public class EntityProvider extends ContentProvider
{
  ...
  private static final String ENTITY_CAN_HANGOUT_INDEX = "ix_entity_can_hangout";
  ...
  {
    String str1 = paramEntity.getId();
    String str2 = paramEntity.getSource();
  ...
  private int mutate(Uri paramUri, ContentValues paramContentValues, String paramString, String[] paramArrayOfString, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 195	com/google/glass/entity/EntityProvider:dbHelper	Lcom/google/glass/entity/EntityProvider$DatabaseHelper;
    //   4: invokevirtual 201	com/google/glass/entity/EntityProvider$DatabaseHelper:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   7: astore 6
    //   9: new 203	com/google/glass/util/SelectionBuilder
    //   12: dup
    //   13: aload_3
    //   14: aload 4
    //   16: invokespecial 206	com/google/glass/util/SelectionBuilder:<init>	(Ljava/lang/String;[Ljava/lang/String;)V
    //   19: astore 7
    //   21: getstatic 126	com/google/glass/entity/EntityProvider:uriMatcher	Landroid/content/UriMatcher;
    //   24: aload_1
    //   25: invokevirtual 210	android/content/UriMatcher:match	(Landroid/net/Uri;)I
    //   28: tableswitch	default:+28 -> 56, 1:+55->83, 2:+96->124, 3:+114->142
    //   57: nop
    //   58: <illegal opcode>
    //   59: dup
    //   60: new 214	java/lang/StringBuilder
    //   63: dup
    //   64: invokespecial 215	java/lang/StringBuilder:<init>	()V
    //   67: ldc 217
    //   69: invokevirtual 221	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   72: aload_1
    //   73: invokevirtual 224	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   76: invokevirtual 227	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   79: invokespecial 230	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   82: athrow
    //   83: ldc 41
    //   85: astore 8
    //   87: iload 5
    ...
    //   94: aload 8
    //   96: aload 7
    //   98: invokevirtual 233	com/google/glass/util/SelectionBuilder:getSelection	()Ljava/lang/String;
    //   101: aload 7
    //   103: invokevirtual 237	com/google/glass/util/SelectionBuilder:getArguments	()[Ljava/lang/String;
    //   106: invokevirtual 243	android/database/sqlite/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   109: istore 15
    //   111: iload 15
    //   113: ifle +8 -> 121
    //   116: aload_0
    //   117: aload_1
    //   118: invokespecial 247	com/google/glass/entity/EntityProvider:notifyChange	(Landroid/net/Uri;)V
    //   121: iload 15
    //   123: ireturn
    //   124: ldc 41
    //   126: astore 8
    ...
    //   130: ldc 249
    //   132: aload_1
    //   133: invokevirtual 252	android/net/Uri:getLastPathSegment	()Ljava/lang/String;
    //   136: invokevirtual 256	com/google/glass/util/SelectionBuilder:addSelection	(Ljava/lang/String;Ljava/lang/String;)V
    //   139: goto -52 -> 87
    //   142: iload 5
    //   144: ifeq +31 -> 175
    ...
    //   164: aload_1
    //   165: invokevirtual 224	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   168: invokevirtual 227	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   171: invokespecial 230	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   174: athrow
    //   175: ldc 41
    //   177: astore 8
    //   179: aload 6
    //   181: aload 8
    //   183: iconst_1
    //   184: anewarray 185	java/lang/String
    //   187: dup
    //   188: iconst_0
    //   189: ldc_w 260
    //   192: aastore
    //   193: aload 7
    //   195: invokevirtual 233	com/google/glass/util/SelectionBuilder:getSelection	()Ljava/lang/String;
    //   198: aload 7
    //   200: invokevirtual 237	com/google/glass/util/SelectionBuilder:getArguments	()[Ljava/lang/String;
    //   203: aconst_null
    //   204: aconst_null
    //   205: aconst_null
    //   206: invokevirtual 264	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   209: astore 9
    //   211: aload 9
    //   213: ifnonnull +49 -> 262
    //   216: getstatic 88	com/google/glass/entity/EntityProvider:logger	Lcom/google/glass/logging/FormattingLogger;
    //   219: astore 16
    //   221: iconst_2
    //   222: anewarray 266	java/lang/Object
    //   225: astore 17
    //   227: aload 17
    //   229: iconst_0
    //   230: aload 7
    //   232: invokevirtual 233	com/google/glass/util/SelectionBuilder:getSelection	()Ljava/lang/String;
    //   235: aastore
    //   236: aload 17
    //   238: iconst_1
    //   239: aload 7
    //   241: invokevirtual 237	com/google/glass/util/SelectionBuilder:getArguments	()[Ljava/lang/String;
    //   244: invokestatic 271	java/util/Arrays:toString	([Ljava/lang/Object;)Ljava/lang/String;
    //   247: aastore
    //   248: aload 16
    //   250: ldc_w 273
    //   253: aload 17
    //   255: invokeinterface 279 3 0
    //   260: iconst_0
    //   261: ireturn
    //   262: aload 9
    ...
    //   273: ifne +12 -> 285
    //   276: aload 9
    //   278: invokeinterface 288 1 0
    //   283: iconst_0
    //   284: ireturn
    //   285: new 290	android/content/ContentValues
    //   288: dup
    //   289: invokespecial 291	android/content/ContentValues:<init>	()V
    //   292: astore 12
    //   294: aload 12
    //   296: ldc_w 260
    //   299: iconst_1
    //   300: aload 9
    //   302: iconst_0
    //   303: invokeinterface 295 2 0
    //   308: iadd
    //   309: invokestatic 301	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   312: invokevirtual 305	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   315: aload 12
    //   317: ldc_w 307
    //   320: aload_0
    //   321: getfield 309	com/google/glass/entity/EntityProvider:clock	Lcom/google/glass/util/Clock;
    //   324: invokeinterface 315 1 0
    //   329: invokestatic 320	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   332: invokevirtual 323	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   335: aload 9
    //   337: invokeinterface 288 1 0
    //   342: aload 12
    //   344: astore_2
    //   345: goto -258 -> 87
    //   348: astore 10
    //   350: aload 9
    //   352: invokeinterface 288 1 0
    //   357: aload 10
    //   359: athrow
    //   360: aload 7
    //   362: invokevirtual 233	com/google/glass/util/SelectionBuilder:getSelection	()Ljava/lang/String;
    //   365: astore 13
    //   367: aload 7
    //   369: invokevirtual 237	com/google/glass/util/SelectionBuilder:getArguments	()[Ljava/lang/String;
    //   372: astore 14
    //   374: aload 6
    //   376: aload 8
    //   378: aload_2
    //   379: aload 13
    //   381: aload 14
    //   383: invokevirtual 326	android/database/sqlite/SQLiteDatabase:update	(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    //   386: istore 15
    //   388: goto -277 -> 111
    //   391: astore 10
    //   393: goto -43 -> 350
  ...
  private static class DatabaseHelper extends SQLiteOpenHelper
  {
    ...
    public void onCreate(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      paramSQLiteDatabase.execSQL("CREATE INDEX ix_entity_can_hangout ON entity(can_hangout);");
    ...
    public void onUpgrade(final SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
    {
      ...
      paramSQLiteDatabase.execSQL("DROP INDEX IF EXISTS ix_entity_can_hangout");
