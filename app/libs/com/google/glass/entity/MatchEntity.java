...
public abstract class MatchEntity extends AsyncTask<Void, Void, TimelineNano.Entity>
{
  ...
  public MatchEntity addPhoneNumber(String paramString)
  {
    ...
    if (!this.target.hasPhoneNumber())
    {
      this.target.setPhoneNumber(paramString);
      return this;
    }
  ...
  protected TimelineNano.Entity doInBackground(Void[] paramArrayOfVoid)
  {
    ...
    if (localEntity1.hasPhoneNumber())
    {
      ...
      localLinkedList.add(0, localEntity1.getPhoneNumber());
    ...
    if (localEntity1.hasId())
    {
      ...
      TimelineNano.Entity localEntity3 = EntityHelper.queryByEmail(localContentResolver, localEntity1.getId());
    ...
    if (localEntity1.hasEmail())
    {
      ...
      TimelineNano.Entity localEntity2 = EntityHelper.queryByEmail(localContentResolver, localEntity1.getEmail());
  ...
  {
    return Strings.nullToEmpty(this.target.getEmail());
  }

  @VisibleForTesting
  public String getPhoneNumber()
  {
    return Strings.nullToEmpty(this.target.getPhoneNumber());
  }
  ...
  public MatchEntity setEmailAddress(String paramString)
  {
    ...
    this.target.setEmail(paramString);
    return this;
  }
}
