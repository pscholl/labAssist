  ...
  implements Serializable
{
  ...
  {
    CompanionInputBoxResponseHandler localCompanionInputBoxResponseHandler = fromBytes(paramInputBoxResponse.getHandlerObject());
    if (localCompanionInputBoxResponseHandler != null)
    {
      if (paramInputBoxResponse.hasResponse())
      {
        localCompanionInputBoxResponseHandler.handleTextTyped(paramContext, paramInputBoxResponse.getResponse());
  ...
  public byte[] toBytes()
  {
    ...
    //   8: aconst_null
    //   9: astore_2
    //   10: new 101	java/io/ObjectOutputStream
    //   13: dup
    //   14: aload_1
    //   15: invokespecial 104	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   18: astore_3
    //   19: aload_3
    //   20: aload_0
    //   21: invokevirtual 108	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   24: aload_1
    //   25: invokevirtual 111	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   28: astore 6
    //   30: aload_3
    //   31: aload_0
    //   32: invokevirtual 115	java/lang/Object:getClass	()Ljava/lang/Class;
    ...
    //   43: aload_1
    //   44: aload_0
    //   45: invokevirtual 115	java/lang/Object:getClass	()Ljava/lang/Class;
    ...
    //   77: aload_2
    //   78: aload_0
    //   79: invokevirtual 115	java/lang/Object:getClass	()Ljava/lang/Class;
    ...
    //   90: aload_1
    //   91: aload_0
    //   92: invokevirtual 115	java/lang/Object:getClass	()Ljava/lang/Class;
    ...
    //   107: aload_2
    //   108: aload_0
    //   109: invokevirtual 115	java/lang/Object:getClass	()Ljava/lang/Class;
    //   112: invokevirtual 46	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   115: ldc 48
    //   117: invokestatic 54	com/google/glass/util/Util:close	(Ljava/io/Closeable;Ljava/lang/String;Ljava/lang/String;)V
    //   120: aload_1
    //   121: aload_0
    //   122: invokevirtual 115	java/lang/Object:getClass	()Ljava/lang/Class;
