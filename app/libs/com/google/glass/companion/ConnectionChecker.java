  ...
  implements NetworkUtil.CompanionNetworkWorker
{
  ...
  private Messenger messenger = new Messenger(new Handler()
  {
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      Proto.CompanionInfo localCompanionInfo = localEnvelope.getCompanionInfo();
      ...
      label239: for (Object localObject = Integer.valueOf(localCompanionInfo.getResponseAndroidVersion()); ; localObject = "0")
      {
        ...
        arrayOfObject2[1] = Long.valueOf(localCompanionInfo.id);
        localFormattingLogger.i("Logging %s for %s", arrayOfObject2);
        if ((localCompanionInfo.getResponseIsNetworkOk()) && (localCompanionInfo.hasResponseAndroidVersion()) && (localCompanionInfo.getResponseAndroidVersion() == 17) && (ConnectionChecker.this.tetheringProblemCounter.incrementAndGet() >= 5))
        {
  ...
  private void sendTetheringErrorMessage()
  {
    ...
    try
    {
      ...
      try
      {
        ...
        localEnvelope.setError(localError);
  ...
  public void reportError()
  {
    ...
    localCompanionInfo.id = l;
    localCompanionInfo.setRequestNetwork(true);
    FormattingLogger localFormattingLogger = logger;
    Object[] arrayOfObject = new Object[1];
    arrayOfObject[0] = Long.valueOf(l);
    localFormattingLogger.v("Requesting companion info, id = %s", arrayOfObject);
    Proto.Envelope localEnvelope = CompanionMessagingUtil.newEnvelope();
    localEnvelope.setCompanionInfo(localCompanionInfo);
    Bundle localBundle = CompanionMessagingUtil.createBundle(localEnvelope, this.messenger);
    try
    {
      this.companionService.send(localBundle);
