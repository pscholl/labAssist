...
.method public isInHangout()Z
    ...
    const-string v4, "com.google.glass.action.HANGOUT_STATUS"
    ...
    .line 216
    .local v0, stickyIntent:Landroid/content/Intent;
    invoke-virtual {p0, v0}, Lcom/google/glass/util/HangoutHelper;->isInHangout(Landroid/content/Intent;)Z
...
.method public isInHangout(Landroid/content/Intent;)Z
    .locals 2
    .parameter "intent"
...
.method public joinConversation(Ljava/lang/String;Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;Z)V
    .locals 5
    ...
    .line 194
    sget-object v2, Lcom/google/glass/util/HangoutHelper;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v3, "Conversation id is null"
    ...
    const-string v3, "shareTarget is null (KI)"
    ...
    const-string v3, "Joining conversation video call ="
