  ...
  implements HotwordRecognizer
{
  ...
  private final MultiRecognizerController controller;
  private MultiRecognizerController.Decoder decoder;

  public EmbeddedGlassRecognizer(Context paramContext, MultiRecognizerController.Decoder paramDecoder)
  {
    this.decoder = paramDecoder;
    this.controller = MultiRecognizerController.getEmbeddedRecognizerController(paramContext);
  ...
  public EmbeddedGlassRecognizer(Context paramContext, MultiRecognizerController.Decoder paramDecoder, String[] paramArrayOfString)
  {
    this.decoder = paramDecoder;
    this.controller = MultiRecognizerController.getEmbeddedRecognizerController(paramContext);
    if (this.controller == null)
    ...
    do
    {
      ...
      Log.logPii(3, TAG, "Compiling custom recognizer " + paramDecoder + " phrases: " + Arrays.toString(paramArrayOfString));
    }
