...
public abstract class BaseVoiceInputActivity extends GlassVoiceActivity
{
  ...
  protected static final VoiceConfig DICTATION = VoiceConfig.forOpenEnded(OpenEndedMode.DICTATION);
  ...
  private TypophileTextView guardPhrase;
  ...
  private VoiceConfig retryVoiceConfig;
  private final Runnable speakAgainRunnable = new Runnable()
  {
    public void run()
    {
      ...
      BaseVoiceInputActivity.this.setVoiceConfig(BaseVoiceInputActivity.this.retryVoiceConfig);
  ...
  protected void onResumeActions()
  {
    ...
    this.guardPhrase = ((TypophileTextView)localView.findViewById(R.id.voice_input_guard_phrase));
    ...
    reset();
    TypophileTextView localTypophileTextView3;
    if (this.guardPhrase != null)
    {
      localTypophileTextView3 = this.guardPhrase;
      if (!shouldShowGuardPhrase())
        break label225;
    }
    label225: for (int i = 0; ; i = 8)
    {
      localTypophileTextView3.setVisibility(i);
      NetworkInfo localNetworkInfo = ((ConnectivityManager)getSystemService("connectivity")).getActiveNetworkInfo();
    ...
    while (true)
    {
      ...
      return;
      label306: localTypophileTextView1.setText(getSelectedCommandText());
    }
  }
  ...
  public void setRetryVoiceConfig(VoiceConfig paramVoiceConfig)
  {
    this.retryVoiceConfig = paramVoiceConfig;
  }
