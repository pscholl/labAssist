  ...
  implements VoiceServiceListener
{
  ...
  public VoiceConfig onVoiceCommand(final VoiceCommand paramVoiceCommand)
  {
    ...
    doOperation(RemoteCallbackBroadcaster.BroadcastTo.ALL, new RemoteVoiceListenerOperation()
    {
      public void doOperation(IVoiceServiceListener paramAnonymousIVoiceServiceListener)
        throws RemoteException
      {
        localAtomicReference.compareAndSet(null, paramAnonymousIVoiceServiceListener.onVoiceCommand(paramVoiceCommand));
      }
    });
