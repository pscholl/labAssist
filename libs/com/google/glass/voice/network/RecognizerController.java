...
import com.google.glass.voice.OpenEndedMode;
...
public class RecognizerController
{
  ...
  {
    if (paramVoiceConfig.getOpenEndedMode() == OpenEndedMode.DICTATION)
      return SessionParams.Mode.SERVICE_API;
    if (paramVoiceConfig.getOpenEndedMode() == OpenEndedMode.SOUND_SEARCH)
  ...
  public void startListening(VoiceConfig paramVoiceConfig, ResampleInputStream.ResampleInputStreamListener paramResampleInputStreamListener)
  {
    ...
    label162: for (SettableFuture localSettableFuture = SettableFuture.create(); ; localSettableFuture = null)
    {
  ...
  private class InternalGrecoListener extends RecognitionEventListenerAdapter
  {
    ...
    public void onError(RecognizeException paramRecognizeException)
    {
      ...
      if ((!TextUtils.isEmpty(this.combinedRecognitionResult)) && (RecognizerController.this.voiceConfig != null) && (RecognizerController.this.voiceConfig.isSearch()) && (localType != SpeechException.Type.NO_MATCH) && ((TextUtils.isEmpty(paramRecognizeException.getMessage())) || ((!paramRecognizeException.getMessage().contains("Manually timed out")) && (!paramRecognizeException.getMessage().contains("Failed direct gws request")))))
      {
        FormattingLogger localFormattingLogger = RecognizerController.logger;
        Object[] arrayOfObject = new Object[2];
