...
public class PhoneCallTimelineHelper
{
  ...
  private void addMenuItems(TimelineNano.TimelineItem paramTimelineItem, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localMenuItem1.setAction(8);
      localMenuItem1.setId(paramString);
      localArrayList.add(localMenuItem1);
      TimelineNano.MenuValue localMenuValue = new TimelineNano.MenuValue();
      localMenuValue.setDisplayName(this.context.getString(R.string.phone_call_reply_menu_display_name));
      localMenuValue.setState(0);
      TimelineNano.MenuItem localMenuItem2 = new TimelineNano.MenuItem();
      localMenuItem2.setAction(2);
  ...
  public static TimelineNano.Attachment createAttachment(String paramString)
  {
    ...
    localAttachment.setContentType("application/vnd.google-glass.phone-call-proto");
    localAttachment.setClientCachePath(paramString);
  ...
  TimelineNano.TimelineItem createTimelineItem()
  {
    ...
    localTimelineItem.setSourceType(2);
    localTimelineItem.setViewType(6);
  ...
  protected TimelineNano.Entity getUnkownEntity()
  {
    ...
    localEntity.setDisplayName(this.context.getString(R.string.phone_call_unknown_caller));
    return localEntity;
  }
    ...
    new AsyncTask()
    {
      ...
      protected Void doInBackground(Void[] paramAnonymousArrayOfVoid)
      {
        ...
        if (paramPhoneCall.isIncomingCall())
        {
          ...
          localTimelineItem.setCreator(localEntity1);
          String str2 = paramPhoneCall.getPhoneNumber();
          if (TextUtils.isEmpty(str2))
            str2 = localEntity1.getPhoneNumber();
          if (!TextUtils.isEmpty(str2))
          {
            TimelineNano.Entity localEntity2 = EntityHelper.clone(localEntity1);
            localEntity2.setId(str2);
            localEntity2.setPhoneNumber(str2);
            localEntity2.setSource("companion:com.google.glass.companion.sms");
        ...
        {
          localTimelineItem.setText(str3);
