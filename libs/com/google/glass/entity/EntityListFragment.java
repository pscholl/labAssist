...
public abstract class EntityListFragment extends GlassFragment
{
  ...
  protected abstract CardScrollAdapter getAdapter();
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    final CardScrollAdapter localCardScrollAdapter = getAdapter();
    this.scrollView.setAdapter(localCardScrollAdapter);
    ...
    localCardScrollAdapter.registerDataSetObserver(new DataSetObserver()
    {
      public void onChanged()
      {
        EntityListFragment.this.sliderView.setCount(localCardScrollAdapter.getCount());
      }
    });
    this.sliderView.setCount(localCardScrollAdapter.getCount());
    return this.view;
  }
