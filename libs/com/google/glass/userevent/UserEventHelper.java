...
public class UserEventHelper
{
  ...
  public static GlassExtensionsNano.GlassUserEventProto createProto(UserEventAction paramUserEventAction, long paramLong, String paramString)
  {
    ...
    localGlassUserEventProto.eventTimeMs = paramLong;
  ...
  {
    return createProto(paramUserEventAction, ClockProvider.get().currentTimeMillis(), paramString);
  }
