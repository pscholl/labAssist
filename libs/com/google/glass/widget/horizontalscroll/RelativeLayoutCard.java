...
public class RelativeLayoutCard extends RelativeLayout
  implements Card
{
  public RelativeLayoutCard(Context paramContext)
  {
    super(paramContext);
  }

  public RelativeLayoutCard(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  public RelativeLayoutCard(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.google.glass.widget.horizontalscroll.RelativeLayoutCard
