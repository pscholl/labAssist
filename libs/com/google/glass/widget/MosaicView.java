...
public class MosaicView extends GridLayout
{
  ...
  private boolean hasLoadingFailure;
  ...
  {
    logger.v("Creating loading task", new Object[0]);
    ...
    localLoadingTask.setOnCompletedListener(new DeferredContentLoader.LoadingTask.CompletionListener()
    {
      public void onCompleted(boolean paramAnonymousBoolean)
      {
        ...
        arrayOfObject[bool] = Integer.valueOf(MosaicView.this.numberOfLoadingTasks);
        localFormattingLogger.v("Completed loading task: %s, number left: %d", arrayOfObject);
        MosaicView localMosaicView = MosaicView.this;
        if (!paramAnonymousBoolean);
        while (true)
        {
          try
          {
            MosaicView.access$602(MosaicView.this, true);
            MosaicView.access$410(MosaicView.this);
            if ((MosaicView.this.numberOfLoadingTasks == 0) && (MosaicView.this.cellsLoadedListener != null))
            {
              MosaicView.CellsLoadedListener localCellsLoadedListener = MosaicView.this.cellsLoadedListener;
              if (!MosaicView.this.hasLoadingFailure)
                localCellsLoadedListener.onCellsLoaded(bool);
            }
            else
            {
              return;
  ...
  private void buildMosaic(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (i3 < i)
      {
        CellSpec localCellSpec2 = localMosaicSpec.cellSpecs[i3];
        GridLayout.LayoutParams localLayoutParams2 = createLayoutParams(localCellSpec2, i1, i2);
        int i9;
        if ((localGroupCountType == GroupCountType.IN_LAST_CELL) && (i3 == i - 1) && (localMosaicSpec.embededRemainingCountLayoutId != -1))
          i9 = j - i;
        for (int i10 = localMosaicSpec.embededRemainingCountLayoutId; ; i10 = localCellSpec2.layoutId)
        {
          addCell(this.subtaskIndex, i3, i9, localLayoutParams2.width, localLayoutParams2.height, i10, localLayoutParams2);
          i3++;
          break;
          i9 = -1;
        }
    ...
    CellSpec localCellSpec1 = localMosaicSpec.cellSpecs[(k - 1)];
    GridLayout.LayoutParams localLayoutParams1 = createLayoutParams(localCellSpec1, i1, i2);
    int i4;
    if (localMosaicSpec.remainingLayoutId != -1)
      i4 = j - i;
    for (int i5 = localMosaicSpec.remainingLayoutId; ; i5 = localCellSpec1.layoutId)
    {
      int i6 = this.subtaskIndex;
      int i7 = localLayoutParams1.width;
      int i8 = localLayoutParams1.height;
      addCell(i6, -1, i4, i7, i8, i5, localLayoutParams1);
      return;
      i4 = -1;
    }
  }
  ...
  {
    public abstract void onCellsLoaded(boolean paramBoolean);
  }
