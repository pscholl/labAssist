...
public class ImageLoaders
{
  ...
  public static ImageLoader forImageUrls(List<String> paramList, PersonImageDownloadTask.LabelVisibility paramLabelVisibility, int paramInt1, int paramInt2)
  {
    ...
    for (int i = 0; i < paramList.size(); i++)
    {
      ...
      localEntity.setId(Integer.toString(i));
  ...
  public static ImageLoader forTimelineItemStaticImage(TimelineNano.TimelineItem paramTimelineItem, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    EntityImageLoader localEntityImageLoader = (EntityImageLoader)forTimelineItem(paramTimelineItem, paramBoolean, paramInt1, paramInt2);
    localEntityImageLoader.setShouldFadeIn(false);
    return localEntityImageLoader;
  }
}
