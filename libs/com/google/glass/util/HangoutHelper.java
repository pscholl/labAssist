...
public class HangoutHelper
{
  ...
  {
    return isInHangout(this.context.getApplicationContext().registerReceiver(null, new IntentFilter("com.google.glass.action.HANGOUT_STATUS")));
  }

  public boolean isInHangout(Intent paramIntent)
  {
    boolean bool1 = false;
    if (paramIntent != null)
    {
      boolean bool2 = paramIntent.getBooleanExtra("participating", false);
      bool1 = false;
      if (bool2)
        bool1 = true;
    }
  ...
  public void joinConversation(String paramString, TimelineNano.Entity paramEntity, boolean paramBoolean)
  {
    if (paramString == null)
    {
      logger.e("Conversation id is null", new Object[0]);
      return;
    }
    if (paramEntity == null)
    {
      logger.e("shareTarget is null (KI)", new Object[0]);
      return;
    }
    String str1 = "Joining conversation video call =" + paramString;
    String str2 = str1 + " with " + paramEntity.getDisplayName() + ", id=" + paramEntity.getId();
    Log.logPii(3, TAG, str2);
    Intent localIntent = generateIntent(paramEntity, paramBoolean);
  ...
  {
    Log.logPii(3, TAG, "Hanging out with " + EntityHelper.getDisplayName(paramEntity) + ", id=" + paramEntity.getId());
