...
public class CachedBitmapFactory
{
  ...
  private DirectoryTracker dcimTracker = null;
  ...
  @VisibleForTesting
  public CachedBitmapFactory(Context paramContext, int paramInt1, int paramInt2, DirectoryTracker paramDirectoryTracker)
  {
    this.context = paramContext;
    this.minWidth = paramInt1;
    this.minHeight = paramInt2;
    this.dcimTracker = paramDirectoryTracker;
  ...
  public final String getCachedAttachmentPath(TimelineNano.Attachment paramAttachment, boolean paramBoolean)
  {
    ...
    if (paramAttachment.hasClientCachePath())
    {
      String str = paramAttachment.getClientCachePath();
    ...
    try
    {
      byte[] arrayOfByte2 = this.attachmentHelper.getAttachmentFromServer(paramAttachment.getId());
      arrayOfByte1 = arrayOfByte2;
      if ((arrayOfByte1 != null) && (arrayOfByte1.length > 0))
      {
        localCachedFilesManager.save(CachedFilesManager.Type.ATTACHMENT, paramAttachment.getId(), FileSaver.newSaver(arrayOfByte1));
    ...
    catch (InterruptedException localInterruptedException)
    {
      while (true)
      {
        ...
        arrayOfObject1[0] = paramAttachment.getId();
        ...
        FormattingLogger localFormattingLogger2 = logger;
        Object[] arrayOfObject2 = new Object[1];
        arrayOfObject2[0] = paramAttachment.getId();
