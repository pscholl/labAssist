  ...
  public static enum Feature
  {
    ...
    static
    {
      ...
      for (boolean bool = true; ; bool = false)
      {
        ...
        AUTOPUSH_SERVERS = new Feature("AUTOPUSH_SERVERS", 15, false);
        ...
        LP_AUD = new Feature("LP_AUD", 32, false);
        SC_RM = new Feature("SC_RM", 33, true);
        FAST_VOICE_PICTURE = new Feature("FAST_VOICE_PICTURE", 34, true);
        KP_OUT = new Feature("KP_OUT", 35, true);
        GRC_VC = new Feature("GRC_VC", 36, false);
        GRC_GRD = new Feature("GRC_GRD", 37, false);
        ...
        WAV1 = new Feature("WAV1", 42, false);
        WK_CH = new Feature("WK_CH", 43, true);
        OHD_MAS = new Feature("OHD_MAS", 44, false);
        I_TORE_DOWN_THIS_APK_AND_ALL_I_GOT_WAS_THIS_STUPID_LAB = new Feature("I_TORE_DOWN_THIS_APK_AND_ALL_I_GOT_WAS_THIS_STUPID_LAB", 45, false);
        VS_MANIA = new Feature("VS_MANIA", 46, false);
        CNS = new Feature("CNS", 47, true);
        ...
        HAWT = new Feature("HAWT", 60, true);
        M_TUI = new Feature("M_TUI", 61, false);
        SC_MS_MD = new Feature("SC_MS_MD", 62, false);
        EA = new Feature("EA", 63, false);
        HMI_SRT = new Feature("HMI_SRT", 64, false);
        CSC = new Feature("CSC", 65, false);
        Feature[] arrayOfFeature = new Feature[66];
        ...
        arrayOfFeature[32] = LP_AUD;
        arrayOfFeature[33] = SC_RM;
        arrayOfFeature[34] = FAST_VOICE_PICTURE;
        arrayOfFeature[35] = KP_OUT;
        arrayOfFeature[36] = GRC_VC;
        arrayOfFeature[37] = GRC_GRD;
        arrayOfFeature[38] = NON_MCKENZIAN;
        arrayOfFeature[39] = LV_SHOW;
        arrayOfFeature[40] = ANS_JS;
        arrayOfFeature[41] = ANS_JSE;
        arrayOfFeature[42] = WAV1;
        arrayOfFeature[43] = WK_CH;
        arrayOfFeature[44] = OHD_MAS;
        arrayOfFeature[45] = I_TORE_DOWN_THIS_APK_AND_ALL_I_GOT_WAS_THIS_STUPID_LAB;
        ...
        arrayOfFeature[60] = HAWT;
        arrayOfFeature[61] = M_TUI;
        arrayOfFeature[62] = SC_MS_MD;
        arrayOfFeature[63] = EA;
        arrayOfFeature[64] = HMI_SRT;
        arrayOfFeature[65] = CSC;
