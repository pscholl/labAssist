...
public class ProtoBufType
{
  ...
  static
  {
    ...
    while (j <= 7)
    {
      int k = 16;
      int n;
      for (int m = i; k < 37; m = n)
      {
        TypeInfo[] arrayOfTypeInfo = NULL_DATA_TYPEINFOS;
        n = m + 1;
        arrayOfTypeInfo[m] = new TypeInfo(k + (j << 8), null);
        k++;
      }
      j++;
      i = m;
 ...
 * Qualified Name:     com.google.userfeedback.android.api.common.io.protocol.ProtoBufType
