...
public class IntMap
{
  ...
  private boolean compareLowerBuffer(Object[] paramArrayOfObject1, Object[] paramArrayOfObject2)
  {
    ...
    if (paramArrayOfObject1.length > paramArrayOfObject2.length)
      for (int m = i; ; m++)
      {
        if (m >= paramArrayOfObject1.length)
          break label120;
        if (paramArrayOfObject1[m] != null)
          break;
      }
    if (paramArrayOfObject1.length < paramArrayOfObject2.length)
      for (int k = i; ; k++)
      {
        if (k >= paramArrayOfObject2.length)
          break label120;
        if (paramArrayOfObject2[k] != null)
          break;
      }
    label120: return true;
  }
  ...
  public int getNumBytesOverhead()
  {
    ...
    Hashtable localHashtable = this.higher;
    int j = 0;
    int k = 0;
    if (localHashtable != null)
    {
      j = 4 * this.higher.size();
      k = 4 * (4 * this.higher.size()) / 3;
    }
    return k + (i + j);
  }
 ...
 * Qualified Name:     com.google.userfeedback.android.api.common.util.IntMap
